...
НЕ БОЙСЯ ЗАНИЖАТЬ ОЦЕНКИ, в этом симуляторе ценится честность и правильые оценки!
...
- **ВАЖНО про роадмап**: поле "roadmap" - ОБЪЕКТ с ключами week1, week2, week3, week4. Каждая неделя - СТРОКА (string) с минимум 5 предложениями. Используй профессиональный луксмакс-сленг и давай конкретные рекомендации по каждой метрике.
