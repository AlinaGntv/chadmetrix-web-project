...
class Payment(Base):
    ...
    payment_method_id = Column(Text, nullable=True)
...
class Analysis(Base):
    ...
    # Требует: ALTER TABLE analyses ADD COLUMN status TEXT DEFAULT 'processing'
    status = Column(Text, nullable=True, default="processing")
