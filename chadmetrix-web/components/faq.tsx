...
const faqs = [
    ...
    },
    {
        ...
        answer: "Подписка HTN (249₽/мес) включает 2 полных анализа в месяц: можно загрузить анфас и профиль. Также вы получаете 1 бесплатное сравнение отчётов «до/после» и доступ к истории с графиками динамики. Подписка CHAD (349₽/мес) добавляет акцентированный отчёт на слабые зоны и 3 сравнения в месяц."
    },
    {
    ...
    },
    {
        ...
        answer: "При подписке вы можете загрузить новое фото через месяц после первого анализа. Система сравнит 17 метрик, покажет динамику по каждому параметру и визуализирует прогресс в виде графиков. Для подписчиков HTN — 1 сравнение/мес, для CHAD — 3 сравнения/мес."
    },
    {
        question: "Что такое акцентированный отчёт в подписке CHAD?",
        answer: "Это расширенный анализ, который детально разбирает 3-4 самые слабые метрики вашего лица. Вместо общих рекомендаций вы получаете углублённый роадмап конкретно по этим зонам: упражнения, уход, коррекция."
    },
    {
